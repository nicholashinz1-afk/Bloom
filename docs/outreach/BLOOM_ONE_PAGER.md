...
Bloom is a free, open-source web app for daily mental health self-care. It combines mood tracking, journaling, habit building, breathing exercises, and peer encouragement into one gentle tool, built for people who are going through it.
...
| **Hard day mode** | Reduces habits to top 2, surfaces crisis resources | Reduces cognitive load during low-capacity moments |
...
Bloom was built by someone who's been through it, for people going through it.
...
- **Zero IT overhead.** It's a web app. Runs in any browser, nothing to install or maintain.
- **No data liability.** All data stays on the student's device. No PHI, no FERPA concerns.
- **Crisis integration.** 988 Lifeline, Crisis Text Line, and international resources are always one tap away.
...
- Single-page progressive web app, deployed on Vercel (static + serverless)
